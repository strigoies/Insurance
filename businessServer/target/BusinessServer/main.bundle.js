...
var ExploreComponent = (function () {
    ...
    ExploreComponent.prototype.ngOnInit = function () {
        ...
        this.router.params.subscribe(function (params) {
            if (params['type'] == "search") {
                ...
                _this.title = "保险类型：" + params['category'];
    ...
    ExploreComponent.prototype.getGenresMovies = function (category) {
        var _this = this;
        this.httpService
            .get(__WEBPACK_IMPORTED_MODULE_4__model_constant__["a" /* constant */].BUSSINESS_SERVER_URL + 'rest/movie/genres?category=' + category)
            .subscribe(function (data) {
            if (data['success'] == true) {
                _this.movies = data['movies'];
            }
    ...
    ExploreComponent.prototype.getGuessMovies = function () {
        var _this = this;
        this.httpService
            .get(__WEBPACK_IMPORTED_MODULE_4__model_constant__["a" /* constant */].BUSSINESS_SERVER_URL + 'rest/movie/guess?num=10&username=' + this.loginService.user.username)
            .subscribe(function (data) {
            if (data['success'] == true) {
                _this.movies = data['movies'];
            }
    ...
    ExploreComponent.prototype.getHotMovies = function () {
        var _this = this;
        this.httpService
            .get(__WEBPACK_IMPORTED_MODULE_4__model_constant__["a" /* constant */].BUSSINESS_SERVER_URL + 'rest/movie/hot?num=10&username=' + this.loginService.user.username)
            .subscribe(function (data) {
            if (data['success'] == true) {
                _this.movies = data['movies'];
            }
    ...
    ExploreComponent.prototype.getNewMovies = function () {
        var _this = this;
        this.httpService
            .get(__WEBPACK_IMPORTED_MODULE_4__model_constant__["a" /* constant */].BUSSINESS_SERVER_URL + 'rest/movie/new?num=10&username=' + this.loginService.user.username)
            .subscribe(function (data) {
            if (data['success'] == true) {
                _this.movies = data['movies'];
            }
    ...
    ExploreComponent.prototype.getRateMoreMovies = function () {
        var _this = this;
        this.httpService
            .get(__WEBPACK_IMPORTED_MODULE_4__model_constant__["a" /* constant */].BUSSINESS_SERVER_URL + 'rest/movie/rate?num=10&username=' + this.loginService.user.username)
            .subscribe(function (data) {
            if (data['success'] == true) {
                _this.movies = data['movies'];
            }
    ...
    ExploreComponent.prototype.getWishMovies = function () {
        var _this = this;
        this.httpService
            .get(__WEBPACK_IMPORTED_MODULE_4__model_constant__["a" /* constant */].BUSSINESS_SERVER_URL + 'rest/movie/wish?num=10&username=' + this.loginService.user.username)
            .subscribe(function (data) {
            if (data['success'] == true) {
                _this.movies = data['movies'];
            }
